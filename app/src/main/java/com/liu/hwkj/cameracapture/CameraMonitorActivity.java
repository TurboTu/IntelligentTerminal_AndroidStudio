package com.liu.hwkj.cameracapture;
...
public class CameraMonitorActivity extends Activity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String rtmpUrl = getString(R.string.VIDEO_PUBLISH_URL) + "/live/" + CommonUtil.getDevicedID(getApplicationContext());;
        SrsEncoder.rtmpUrl = sp.getString("rtmpUrl", rtmpUrl);
