...
import com.liu.hwkj.intelligent.EMapActivity;
 ...
 */
@SuppressLint("NewApi")
public class EMapGeofence implements OnClickListener {
    ...
    public EMapGeofence(Context context, LayoutInflater inflater) {
    ...
    public static void addEntity() {
        // entity标识
        String entityName = EMapActivity.entityName;
        // 属性名称（格式 : "key1=value1,columnKey2=columnValue2......."）
        String columnKey = "name=testName";
        EMapActivity.client.addEntity(EMapActivity.serviceId, entityName, columnKey, EMapActivity.entityListener);
    }
    ...
    private void createFence() {
        ...
        // 创建者（entity标识）
        String creator = EMapActivity.entityName;
        // 围栏名称
        String fenceName = EMapActivity.entityName + "_fence";
        // 围栏描述
        String fenceDesc = "test";
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = EMapActivity.entityName;
        // 观察者列表（多个entityName，以英文逗号"," 分割）
        String observers = EMapActivity.entityName;
        // 生效时间列表
        ...
        // 围栏半径（单位 : 米）
        double radius = EMapGeofence.radius;
        // 报警条件（1：进入时触发提醒，2：离开时触发提醒，3：进入离开均触发提醒）
        int alarmCondition = 3;

        EMapActivity.client.createCircularFence(EMapActivity.serviceId, creator, fenceName, fenceDesc,
    ...
    private static void deleteFence(int fenceId) {
        EMapActivity.client.deleteFence(EMapActivity.serviceId, fenceId, geoFenceListener);
    }
    ...
    private void updateFence() {
        ...
        String fenceName = EMapActivity.entityName + "_fence";
        // 围栏ID
        int fenceId = EMapGeofence.fenceId;
        // 围栏描述
        ...
        EMapActivity.client.updateCircularFence(EMapActivity.serviceId, fenceName, fenceId, fenceDesc,
                monitoredPersons,
    ...
    protected static void queryFenceList() {
        ...
        // 围栏ID列表
        String fenceIds = "";
        EMapActivity.client.queryFenceList(EMapActivity.serviceId, creator, fenceIds, geoFenceListener);
    }
    ...
    private void monitoredStatus() {
        ...
        // 监控对象列表（多个entityName，以英文逗号"," 分割）
        String monitoredPersons = EMapActivity.entityName;
        EMapActivity.client.queryMonitoredStatus(EMapActivity.serviceId, fenceId, monitoredPersons,
                geoFenceListener);
    }
    ...
    private void historyAlarm() {
        ...
        EMapActivity.client.queryFenceHistoryAlarmInfo(EMapActivity.serviceId, fenceId, monitoredPersons, beginTime,
                endTime,
                geoFenceListener);
    }
    ...
    private void delayAlarm() {
        ...
        int fenceId = EMapGeofence.fenceId;
        // 观察者列表（多个entityName，以英文逗号"," 分割）
        String observer = EMapActivity.entityName;
        // 延迟时间（unix时间戳）
        int delayTime = (int) (System.currentTimeMillis() / 1000 + this.delayTime * 60);
        EMapActivity.client.delayFenceAlarm(EMapActivity.serviceId, fenceId, observer, delayTime,
                geoFenceListener);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_setfence:
                inputDialog();
                EMapActivity.mBaiduMap.setOnMapClickListener(mapClickListener);
    ...
    private void initOnGeoFenceListener() {
        ...
        geoFenceListener = new OnGeoFenceListener() {
            ...
            public void onRequestFailedCallback(String arg0) {
                ...
                Toast.makeText(EMapActivity.mContext, "geoFence请求失败回调接口消息 : " + arg0, Toast.LENGTH_LONG).show();
        ...
        builder.setTitle("围栏半径(单位:米)").setView(circleRadius)
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO Auto-generated method stub
                        EMapActivity.mBaiduMap.setOnMapClickListener(null);
                    }
    ...
    private void showMessage(String message) {
        Looper.prepare();
        Toast.makeText(EMapActivity.mContext, message, Toast.LENGTH_LONG).show();
        Looper.loop();
    }
