...
@SuppressLint("NewApi")
public class BaiduTraceActivity extends FragmentActivity implements OnClickListener {
     ...
     */
    protected static long serviceId = 116072;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidu_tarce);
