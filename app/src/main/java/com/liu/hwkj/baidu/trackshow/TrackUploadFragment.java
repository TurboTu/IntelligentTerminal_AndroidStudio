...
public class TrackUploadFragment extends Fragment {
    ...
    private void init() {
        ...
        tvEntityName.setText(" entityName : " + BaiduTraceActivity.entityName + " ");
        ...
        btnStartTrace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isRegister) {
                    if (null == pm) {
                        pm = (PowerManager) BaiduTraceActivity.mContext.getSystemService(Context.POWER_SERVICE);
                    }
                    if (null == wakeLock) {
                    ...
                    BaiduTraceActivity.mContext.registerReceiver(powerReceiver, filter);
                    isRegister = true;
                }
        ...
        btnStopTrace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isRegister) {
                    try {
                        BaiduTraceActivity.mContext.unregisterReceiver(powerReceiver);
                        isRegister = false;
                    } catch (Exception e) {
                        // TODO: handle
                    }
    ...
    public void startMonitorService() {
        serviceIntent = new Intent(BaiduTraceActivity.mContext,
                com.liu.hwkj.baidu.trackshow.MonitorService.class);
        BaiduTraceActivity.mContext.startService(serviceIntent);
    }
    ...
    private void startTrace() {
        ...
        BaiduTraceActivity.client.startTrace(BaiduTraceActivity.trace, startTraceListener);
    ...
    private void stopTrace() {
        ...
        BaiduTraceActivity.client.stopTrace(BaiduTraceActivity.trace, stopTraceListener);

        // 停止监听service
        MonitorService.isCheck = false;
        MonitorService.isRunning = false;
        BaiduTraceActivity.mContext.stopService(serviceIntent);
    }
    ...
    private void setInterval() {
        BaiduTraceActivity.client.setInterval(gatherInterval, packInterval);
    }
    ...
    protected static void setRequestType() {
        int type = 0;
        BaiduTraceActivity.client.setProtocolType(type);
    }
    ...
    private void queryRealtimeLoc() {
        BaiduTraceActivity.client.queryRealtimeLoc(BaiduTraceActivity.serviceId, BaiduTraceActivity.entityListener);
    }
    ...
    private void queryEntityList() {
        ...
        String entityNames = BaiduTraceActivity.entityName;
        ...
        BaiduTraceActivity.client.queryEntityList(BaiduTraceActivity.serviceId, entityNames, columnKey, returnType, activeTime,
                pageSize,
                pageIndex, BaiduTraceActivity.entityListener);
    }
    ...
    protected static void addMarker() {
        ...
        if (null != msUpdate) {
            BaiduTraceActivity.mBaiduMap.setMapStatus(msUpdate);
        }

        // 路线覆盖物
        if (null != polyline) {
            BaiduTraceActivity.mBaiduMap.addOverlay(polyline);
        }

        // 围栏覆盖物
        if (null != Geofence.fenceOverlay) {
            BaiduTraceActivity.mBaiduMap.addOverlay(Geofence.fenceOverlay);
        }

        // 实时点覆盖物
        if (null != overlay) {
            BaiduTraceActivity.mBaiduMap.addOverlay(overlay);
        }
    }
    ...
    private void showMessage(final String message, final Integer errorNo) {
        ...
        new Handler(BaiduTraceActivity.mContext.getMainLooper()).post(new Runnable() {
            public void run() {
